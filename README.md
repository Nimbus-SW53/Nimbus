...
|  -------------------  |  -------------------  |  -------------------------------------------------  |
|Participa en equipos multidisciplinarios con eficacia, eficiencia y objetividad, en el marco de un proyecto en soluciones de ingeniería de software.|**Moreno Rosales, Claudio Jesús**<br><br> **TB1:** En el transcurso del proyecto se ha tenido que realizar una comunicación efectiva con los segmentos objetivo e interesados del proyecto, para obtener la mayor cantidad de requisitos y necesidades posibles, esto ayuda a construir un mejor diseño de proyecto ágil.<br><br>**TP:** El equipo se organizó para realizar las mejoras del proyecto y realizar el primer avance de la Web Application teniendo encuenta las habilidade de cada integrante del equipo.<br><br>**TB2:** El equipo se organizó para avanzar diferentes partes del proyecto relacionados con el Backedn y tuvo que hacer muchas coordinaciones previas. <br><br>**TF:** Para esta unidad se trabajó en el desarrollo del backend, el equipo logró trabajar y aportar con sus diversas cualidades de manera ágil.<br> <br>**Zeta Valenzuela, Christian Jose**<br><br> **TB1:** En el transcurso del proyecto se ha tenido que realizar una comunicación efectiva con los segmentos objetivo e interesados del proyecto, para obtener la mayor cantidad de requisitos y necesidades posibles, esto ayuda a construir un mejor diseño de proyecto ágil.<br><br>**TP:** El equipo se organizó para realizar las mejoras del proyecto y realizar el avance de la Web Application teniendo encuenta las habilidade de cada integrante del equipo.<br><br>**TB2:** El equipo se organizó para avanzar diferentes partes del proyecto relacionados con el Backedn. <br><br>**TF:** Para esta unidad se trabajó en el desarrollo del backend, el equipo logró trabajar y aportar con sus diversas cualidades de manera ágil. <br> <br>**Hinostroza Mavila, Farid Rolando** <br><br>**TB1:** Despues de las entrevistas realizadas, se hicieron a cargo las funcionalidades pedidas por los usuarios, desarollo de mockups posteriores a diagramas e implementación de base de datos. <br><br>**TB2:**La organización de reuniones estratégicas fue clave para capitalizar las habilidades individuales de cada miembro del equipo. Este enfoque permitió el desarrollo de un producto competente y funcional, destacando la eficacia, eficiencia y objetividad en nuestro trabajo conjunto.  <br><br>**TP:** Después de realizar nuevas entrevistas, se identificaron mejoras significativas en el Backend, lo que llevó a una coordinación más efectiva de nuestros esfuerzos como equipo multidisciplinario.  <br> <br>**TF:** A  lo largo de los desafíos y aciertos encontrados, logramos finalizar la creación y desarrollo de la WebApp. La implementación exitosa de mejoras consolidó la culminación total del proyecto Nimbus, demostrando nuestra capacidad para trabajar eficaz y objetivamente en soluciones de ingeniería de software dentro de un equipo multidisciplinario <br><br>**Horna Silva, Fabio** | **TB1**: Mantenimiento de comunicación efectiva con los interesados del proyecto. **TP**: Organización del equipo para mejoras del proyecto y desarrollo de la Web Application. **TB2**: Enfoque en el avance de diferentes secciones del proyecto, especialmente en Backend. **TF**: Encargo de funcionalidades demandadas por los usuarios, incluyendo desarrollo de mockups y base de datos.<br><br>**Portales Ortiz, Diego Alejandro**<br><br> **TB1:** Durante las primeras etapas del proyecto se tuvo que fomentar una buena comunicación tanto entre los miembros del equipo como con los usuarios objetivo.<br><br>**TP:** El equipo tuvo que organizar diversas reuniones para de este modo se puedan aprovechar las habilidades de cada integrante, con el fin de desarrollar un producto competente y funcional.<br><br>**TB2:** Se tuvo que hacer muchas mejoras al Backend tras las nuevas Interviews, además de coordinar mejor nuestros esfuerzos como equipo. <br><br>**TF:** Tras muchos obstáculos y también aciertos, se pudo culminar la creación y desarrollo de la WebApp, pues todas las mejoras fueron implementadas, concretando finalmente la creación total de Nimbus.  | **TB1:** El equipo de desarrollo ha logrado realizar múltiples funciones para la recopilación de información, diseño, entrevistas, documentación y programación que ha dado un valor más al proyecto.<br><br>**TP:** Para el Sprint 2 se realizó la primera versión de la Web Application teniendo en cuenta las habilidade que cada integrante puede aportar hacia el proyecto, además, se logró realizar las correciones de la estructura del proyecto para lograr la mejora contínua.<br><br>**TB2:** El equipo se ha organizado y ha trabajo en conjunto para lograr qu el Backend cumpla con todas las expectavisas que al final se visualizaran en el Frontend y seran usadas por los clientes.
|Conoce al menos un sector empresarial o dominio de aplicación de soluciones de software. |**Moreno Rosales, Claudio Jesús** <br><br>**TB1:** Después de haber recolectado la información necesaria sobre nuestro público objetivo, interesados y haber realizado las entrevistas e investigaciones, se tradujo toda la información en arquetipos Persona y User Stories.<br><br>**TP:** Se identificó correctamente el sector al que Nimbus quiere llegar y se implemento la Web Application teniendo en cuenta todos los requisitos.<br><br>**TB2:** Durante la fase de desarrollo hemos tenido que conoce más a detalle a los usuarios para que el Backedn responda a esas reglas de negocio, ya que se relizaron las validation interviews que ponen a prueba el proyecto.<br><br>**TF** El equipo demostró eficacia, eficiencia y objetividad al participar en equipos multidisciplinarios en un proyecto de ingeniería de software. Destacaron en la colaboración, comunicación efectiva y adaptación a las necesidades del proyecto, lo que contribuyó al éxito del mismo. Además, su conocimiento del mercado y la identificación de requisitos de usuario fueron fundamentales para cumplir con el criterio específico. <br> <br> **Zeta Valenzuela,Christian Jose ** <br><br>**TB1:** Después de haber recolectado la información necesaria sobre nuestro público objetivo, interesados y haber realizado las entrevistas e investigaciones, se tradujo toda la información en arquetipos Persona y User Stories.<br><br>**TP:** Se identificó correctamente el sector al que Nimbus quiere llegar y se implemento la Web Application teniendo en cuenta todos los requisitos.<br><br>**TB2:** Durante la fase de desarrollo hemos tenido que conoce más a detalle a los usuarios para que el Backedn responda a esas reglas de negocio, ya que se relizaron las validation interviews que ponen a prueba el proyecto.<br><br>**TF** El equipo demostró eficacia, eficiencia y objetividad al participar en equipos multidisciplinarios en un proyecto de ingeniería de software. Destacaron en la colaboración, comunicación efectiva y adaptación a las necesidades del proyecto, lo que contribuyó al éxito del mismo. Además, su conocimiento del mercado y la identificación de requisitos de usuario fueron fundamentales para cumplir con el criterio específico.  <br> <br>Hinostroza Mavila, Farid Rolando <br><br>TB1: Después de analizar las necesidades específicas del sector empresarial, se asumieron las funciones solicitadas por los usuarios. Se llevó a cabo la creación de mockups después de diagramas y la implementación de la base de datos para satisfacer las demandas particulares de la aplicación en ese dominio específico. <br><br>TB2: La realización de reuniones estratégicas fue esencial para aprovechar las habilidades individuales de cada miembro del equipo en el contexto del sector empresarial identificado. Este enfoque facilitó el desarrollo de un producto competente y funcional, resaltando la eficacia, eficiencia y objetividad en nuestra colaboración conjunta. <br><br>TP: Tras realizar análisis adicionales del sector empresarial, se detectaron mejoras significativas en el Backend, lo que condujo a una coordinación más efectiva de nuestros esfuerzos como equipo multidisciplinario enfocado en soluciones de software para ese dominio específico. <br> <br>TF: A lo largo de los retos y aciertos encontrados, logramos concluir la creación y desarrollo de la WebApp orientada a las necesidades del sector empresarial identificado. La implementación exitosa de mejoras consolidó la culminación total del proyecto Nimbus, demostrando nuestra capacidad para trabajar de manera eficaz y objetiva en soluciones de ingeniería de software dentro de un equipo multidisciplinario, específicamente en el ámbito empresarial. <br> <br>**Portales Ortiz, Diego Alejandro** <br><br>**TB1:** Luego de elegir nuestro público objetivo, pudimos organizar las respectivas entrevistas a cada sector objetivo para finalmente con esa información formar los User Stories y User Personas.<br><br>**TP:** Se tiene en cuenta el público objetivo al que Nimbus está enfocado para así implementar las primeras funcionalidades.<br><br>**TB2:** Tras entrevistar nuevamente a nuestros User Personas, tuvimos que hacer modificaciones al backend para así satisfacer correctamente sus necesidades.<br><br>**TF** El equipo destacó por su eficacia y eficiencia en proyectos de ingeniería de software, demostrando habilidades clave en colaboración y comunicación. Su adaptabilidad y comprensión del mercado fueron fundamentales para el éxito del proyecto. |**TB1:** Con la recopilación de información sobre diversos segmentos objetivos e interesados en el proyecto, se ha conocido más de cerca a que público y mercado estamos atacando, ya que esto servirá para realizar un proyecto más personalizado y de mejor valor.<br><br>**TP:** Todos los requisitos extraidos desde las User Stories fueron algunos seleccionados para el Sprint 2 con la finalidad de tener avaces graduales. <br><br>**TB2:** Con la ayuda de las Validation Interviews, hemos llegado a conocer mejor nuestro segmento de mercado que atacamos y como podemos mejorar para que el cliente se sienta satisfecho con toda la Web App realizada.<br><br>**TF:** Con la culminación del Backend y tras haber usado de guía las nuevas Interviews realizadas en el anterior Sprint, pudimos crear una WebApp funcional y que cumple con todas las expectativas del público objetivo  |
...
| Web Application     | Cantidad de videos: 1<br>Nomenclatura: upc-pre-202302-si729-SW53-StratusSphere-webapplication<br>Formato: .mp4 <br>Duración: 12 minutos            | En este video exponemos todo sobre la aplicación Nimbus y sus diferentes funcionalidades.                                        | La web application es un modelo sólido sobre el cual trabajar para terminar el proyecto al 100%.                          |
| Presentación TB1    | Cantidad de videos: 1<br>Nomenclatura: upc-pre-202302-si729-SW53-StratusSphere-presentacion-tb1<br>Formato: .mp4 <br>Duración: 3 minutos           | Exposición sobre el avance del trabajo (TB1).                                                                                    | Exposición del avance y estado actual del proyecto.                                                                      |
| Presentación TB2    | Cantidad de videos: 1<br>Nomenclatura: upc-pre-202302-si729-SW53-StratusSphere-presentacion-tb2<br>Formato: .mp4 <br>Duración: 3 minutos           | Exposición sobre el avance del trabajo (TB2).                                                                                    | Exposición del avance y estado actual del proyecto.                                                                      |
| Presentación TP     | Cantidad de videos: 1<br>Nomenclatura: upc-pre-202302-si729-SW53-StratusSphere-presentacion-tp<br>Formato: .mp4 <br>Duración: 3 minutos            | Exposición sobre el avance del trabajo (TP).                                                                                     | Exposición del avance y estado actual del proyecto.                                                                      |
